$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/features/desafio_bdd.feature");
formatter.feature({
  "name": "Testar site da Amazon",
  "description": "",
...
formatter.step({
  "name": "que estou na home page da Amazon.com.br",
  "keyword": "Dado "
});
formatter.match({
  "location": "DesafioBddSteps.queEstouNaHomePageDaAmazonComBr()"
});
formatter.result({
  "status": "skipped"
});
